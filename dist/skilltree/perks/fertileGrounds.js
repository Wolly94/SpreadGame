...
var name = "FertileGrounds";
var defaultValues = [6, 12, 18];
var defaultValue = 0;
var getReturnValue = function (cellId, additionalGrowth) {
    var props = __assign(__assign({}, growth_1.growthUtils.default), { additionalGrowthInPercent: additionalGrowth });
    var res = {
