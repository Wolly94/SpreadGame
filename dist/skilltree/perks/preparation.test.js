...
test("test preparation", function () {
    ...
    expect((_a = cell2 === null || cell2 === void 0 ? void 0 : cell2.data) === null || _a === void 0 ? void 0 : _a.defenderCombatAbilities).toBeGreaterThan(5);
    ...
    expect(cell2 === null || cell2 === void 0 ? void 0 : cell2.playerId).toBe(1);
    expect((_b = cell2 === null || cell2 === void 0 ? void 0 : cell2.data) === null || _b === void 0 ? void 0 : _b.defenderCombatAbilities).toBe(0);
});
...
test("test preparation cap", function () {
    ...
    var clientState = game.toClientGameState();
    var cell2 = clientState.cells.find(function (c) { return c.id === 1; });
    expect((_a = cell2 === null || cell2 === void 0 ? void 0 : cell2.data) === null || _a === void 0 ? void 0 : _a.defenderCombatAbilities).toBe(100);
    var oldValue = cell2 === undefined ? 0 : (_b = cell2 === null || cell2 === void 0 ? void 0 : cell2.data) === null || _b === void 0 ? void 0 : _b.defenderCombatAbilities;
    game.runReplay(rep, 5000);
    clientState = game.toClientGameState();
    cell2 = clientState.cells.find(function (c) { return c.id === 1; });
    expect(oldValue).toBe((_c = cell2 === null || cell2 === void 0 ? void 0 : cell2.data) === null || _c === void 0 ? void 0 : _c.defenderCombatAbilities);
});
